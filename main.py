...
async def info_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(f'Здесь актуальная информация по клану, кастомкам и т.д🖤 Смотри <a href="{INFO_URL}">здесь</a>', parse_mode="HTML")
...
async def pipisa(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if delta > 0:
        ...
        msg = f"🍆Твоя пиписа выросла на {delta:.1f} см! {phrase} Твоя пиписа теперь {new_val:.1f} см."
    else:
        phrase = random.choice([
